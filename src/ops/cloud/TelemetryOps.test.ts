...
describe('TelemetryOps', () => {
  ...
  describe('Telemetry lifecycle', () => {
    async function testTelemetryLifecycle(exporters: TelemetryExporters, category?: TelemetryOps.TelemetryCategory, exporterId?: string) {
      ...
      const updated = {
        ...
        endpoint: 'https://updated.example.com/v1/logs',
      };
