 ...
 *
 *        FRODO_RECORD_PHASE=1 FRODO_HOST=frodo-dev npm run test:record EnvSSOCookieConfigApi
 *        FRODO_RECORD_PHASE=2 FRODO_HOST=frodo-dev npm run test:record EnvSSOCookieConfigApi
 *        FRODO_RECORD_PHASE=3 FRODO_HOST=frodo-dev npm run test:record EnvSSOCookieConfigApi
 *
 ...
 *    by running:
 *
 *        FRODO_DEBUG=1 npm run test:update EnvSSOCookieConfigApi
 *
 * 3. Test your changes
 *
...
describe('EnvSSOCookieConfigApi', () => {
  ...
  if (
    ...
    describe('getSSOCookieConfig()', () => {
      test('0: Method is implemented', async () => {
        expect(EnvSSOCookieConfigApi.getSSOCookieConfig).toBeDefined();
      });

      test(`1: Get SSO Cookie Config - success`, async () => {
        const response = await EnvSSOCookieConfigApi.getSSOCookieConfig({
          state,
        });
  ...
  if (
    ...
    describe('setSSOCookieConfig()', () => {
      test('0: Method is implemented', async () => {
        expect(EnvSSOCookieConfigApi.setSSOCookieConfig).toBeDefined();
      });

      test(`1: Set custom SSO cookie config - success`, async () => {
        const response = await EnvSSOCookieConfigApi.setSSOCookieConfig({
          config: customSSOCookieConfig,
          state,
        });
        expect(response).toMatchSnapshot();
  ...
  if (
    ...
    describe('resetSSOCookieConfig()', () => {
      test('0: Method is implemented', async () => {
        expect(EnvSSOCookieConfigApi.resetSSOCookieConfig).toBeDefined();
      });

      test(`1: Reset custom SSO cookie config - success`, async () => {
        const response = await EnvSSOCookieConfigApi.resetSSOCookieConfig({
          state,
        });
        expect(response).toMatchSnapshot();
      });
